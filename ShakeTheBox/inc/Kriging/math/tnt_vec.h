...
class Vector 
{
  ...
  protected:
	...
	//////////////////////////////////////////////////////////////////////////
	//ZALIPUHA оптимизация скорости
  public:
	static T *m_extaBuf;

	static void AllocExtraBuf(int N)
	{
		if ( m_extaBuf == 0 ) 
		{
			m_extaBuf = (T*)malloc(N * sizeof(T));
			m_extaBufSize = N;
			assert(m_extaBuf != 0);
		}
		if ( N != m_extaBufSize )
	...
	static void DeallocateExtraBuf()
	{
		if ( m_extaBuf != 0 ) 
		{
			free(m_extaBuf);
...
//ZALIPUHA оптимизация скорости
template <class T>
T *Vector<T>::m_extaBuf = 0;

template <class T>
int Vector<T>::m_extaBufSize = 0;
//////////////////////////////////////////////////////////////////////////
